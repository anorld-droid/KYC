...
private val DarkColorPalette = KYCColors(
    brand = Lavender1,
    brandSecondary = Neutral4,
    uiBackground = Neutral8,
    uiBorder = Neutral3,
    uiFloated = FunctionalDarkGrey,
    textPrimary = Lavender0,
    textSecondary = Neutral0,
    textHelp = Neutral1,
    textInteractive = Neutral7,
    textLink = Ocean2,
    iconPrimary = Lavender2,
    iconSecondary = Neutral0,
    iconInteractive = Neutral7,
    iconInteractiveInactive = Neutral6,
    error = FunctionalRedDark,
    gradient6_1 = listOf(Rose5, Ocean7, Rose9, Ocean7, Rose5),
...
private val LightColorPalette = KYCColors(
    brand = Lavender1,
    ...
    error = FunctionalRed,
    gradient6_1 = listOf(Rose4, Ocean3, Rose2, Ocean3, Rose4),
...
fun ProvideKYCColors(
    ...
    CompositionLocalProvider(LocalKYCColors provides colorPalette, content = content)
}

object KYCTheme {
    val colors: KYCColors
        @Composable
        get() = LocalKYCColors.current
}
...
private val LocalKYCColors = staticCompositionLocalOf<KYCColors> {
    error("No TweetHeartColorPalette provided")
}
